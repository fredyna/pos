    ...
    <div class="col-md-12">
      <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Transaksi Perdana Sementara</h3>
          ...
          <div class="box-body">
            ...
            <?php
                ...
                echo form_open('transaksi/editTransaksiPerdanaSementara/'.$trx->nama_operator.'/'.$trx->jenis,$name);
            ?>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-4">
                  <a href="<?php echo base_url('transaksi/perdana');?>" class="btn btn-info btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
